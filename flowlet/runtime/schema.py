...
class RuntimeEventType(StrEnum):
    ...
    BACKEND_SESSION_ACQUIRED = "backend_session.acquired"
    BACKEND_SESSION_RENEWED = "backend_session.renewed"
    BACKEND_SESSION_RELEASED = "backend_session.released"
    BACKEND_SESSION_EXPIRED = "backend_session.expired"
    ...
    PROCESS_ATTEMPT_FAILED = "process.attempt.failed"
    PROCESS_ATTEMPT_CANCELLED = "process.attempt.cancelled"
    PROCESS_ATTEMPT_INTERRUPTED = "process.attempt.interrupted"
